...
SECRET_KEY = '*@@ng$kav)9$8(=^z04ppz4og!n@q%mbd4+xu82tyx$&(z@!=7'
...
# Static files (CSS, JavaScript, Images , else)
...
LOGIN_REDIRECT_URL = 'uberai-dashboard'
